...
private static DataSource ds;
	...
	*/
	...
	public ArrayList<OrderItem> doRetrieveAll(int orderID) throws SQLException {
		...
		String selectSQL = "SELECT * FROM " + OrderItemModelDS.TABLE_NAME + " WHERE ORDER_ID = ?";
	...
	public void doSaveAll(ArrayList<OrderItem> ordered) throws SQLException 
	{
		...
		String insertSQL = "INSERT INTO " + OrderItemModelDS.TABLE_NAME + " (PRODUCT_CODE,ODER_QUANITITY) VALUES (?,?)";
