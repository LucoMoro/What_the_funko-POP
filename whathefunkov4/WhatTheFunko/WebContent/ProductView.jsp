...
<a href="ProductView.jsp"><img id="logo" src="./Images/logo.png"  alt="logo" style="width:35%"></a>


<div id="div1">
<ul >
  <li class="nb"> <a href="" class="nbup"> Coffee</a></li>  
  <li class="nb"><a href="" class="nbup">Tea</a></li>
  <li id="link">Milk
  <ul>
  	<li class="mt"><a href="" class="lg">4lettere</a> </li>
  	<li class="mt"><a href="" class="lg">4lettere</a></li>
  	<li class="mt"><a href="" class="lg">4lettere</a></li>
	</ul>
   </li>
...
<div id="div2">
<ul>
<li class="nb"> <a href="Carrello.jsp" class="nbup"> Carrello</a></li>  
<li class="nb"><a href="Login.jsp" class="nbup">Login</a></li>
</ul>
</div>
</nav>
